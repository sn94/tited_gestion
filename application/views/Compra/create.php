...
<div class="row">
<!-- campos ocultos -->  
<input type="hidden" name="compra_estado" value="C"> 
...
<!-- tipo de venta-->
<div class="input-field col s2"><p><input name="compra_tipo"  checked="<?= set_value('compra_tipo')=='CO'? true: false ?>" type="radio" checked id="r_cont" value="CO"><label for="r_cont"/>Contado</label></p><p><input name="venta_tipo"  checked="<?= set_value('venta_tipo')=='CR'? true: false ?>"  type="radio" id="r_cred" value="CR"><label for="r_cred">Cr&eacute;dito</label></p></div>
<!-- total factura-->
...
<div class="row">
<!-- foto-->
<div class="input-field col s6"><input   name="venta_foto" type="file" class="validate"  onchange="show_loaded_image( event , '#compra_foto')"> </div><div  class="input-field col s6" id="compra_foto" style="max-height: 100px; max-width: 100px;"></div>
</div><!-- END row -->
